<?php
    ...
    if ($_SESSION['userType'] == "Pelanggan") {
        $sql = "SELECT Pelanggan_pe_id FROM transaksi where t_id = '$transactionId'";
        $result = mysqli_query($db, $sql);
        $data = mysqli_fetch_assoc($result);
        $idPelanggan = $data['Pelanggan_pe_id'];

        $sql = "SELECT * FROM pelanggan WHERE pe_nama = '$username' AND pe_id = '$idPelanggan'";
        $result = mysqli_query($db, $sql);
...
<body>
    ...
    <div class="content">
        ...
        <a href="reservation-list.php" class="button"> Back to Reservation List </a>
    </div>
</body>
</html>
