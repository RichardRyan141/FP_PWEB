<?php
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: edit-review.php?id=" . $row['t_id']);
        exit();
    }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "INSERT INTO review (rv_detail, Transaksi_t_id) VALUES ('$rv_detail', '$transactionId')";
    ...
    <div class="content">
        ...
        <div class="form-container">
            <form method="post" action="">
                ...
                <textarea id="rv_detail" name="rv_detail" rows="15" class="text-box"></textarea>
